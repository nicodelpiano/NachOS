...
class Thread {
  private:
    ...
    bool joinable; //agregado el valor para JOIN
    Puerto *puerto; //puerto correspondiente para Join()

  public:
    Thread(const char* debugName);	// initialize a Thread 

    Thread(const char* debugName,bool joinflag); //agregado nuevo constructor para JOIN

	Thread(const char* debugName,bool joinflag,int prior); //agregado nuevo constructor para COLAS DE PRIORIDAD
  ...
  int oldPriority;
    ...
    OpenFileId addFile(OpenFile*);
    OpenFile* Return(OpenFileId ofid);
    OpenFile* RemoveFid(OpenFileId ofid);

...
// 2007, Jose Miguel Santos Espino
    ...
    //if (randomYield)				// start the timer (if needed)
									//sacamos esta linea para forzar cambios de contexto
    ...
    spaceThread = new SpaceThreadTable();
	coremap = new CoreMap(NumPhysPages);
	counter = 0;
#endif

//lista global para usar las politicas de paginacion
#ifdef VM
	pp_list = new List<int>;
#endif

...
// Routines internal to the machine simulation -- DO NOT call these 
    ...
    bool ReadMem(int addr, int size, int* value); // addr es una direccion de mips, lee tanto size y lo guarda en value.
    bool WriteMem(int addr, int size, int value); // addr es una direccion de mips, escribe tanto size y lo guarda en value.
